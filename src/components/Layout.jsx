  ...
  return (
    <AuroraBackground>
      ...
      <motion.nav
        ...
        className="fixed top-0 w-full z-50 flex items-center justify-between px-6 py-4 md:px-12 backdrop-blur-xl bg-black/10 border-b border-white/5"
      >
        <Link
          to="/"
        ...
        <div className="hidden md:flex items-center gap-4">
          {navLinks.map((link) => (
            <NavLink
              ...
              onMouseLeave={() => setCursorVariant("default")}
              className={({ isActive }) =>
                `px-5 py-2.5 rounded-xl text-[10px] font-bold font-mono-space tracking-[0.2em] cursor-none transition-all duration-300 border backdrop-blur-md ${
                  isActive
                    ? "bg-white/10 border-emerald-500/50 text-white shadow-[0_0_20px_rgba(16,185,129,0.1)]"
